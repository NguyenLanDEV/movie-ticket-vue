<template>
  <a-form :model="formState"
    ...
    <a-form-item label="Description" name="description" v-bind="validateInfos.description" :validateStatus="formErrors.description ? 'error' : '' " :help="formErrors.description">
      ...
      <a-form-item label="Release Time:" name="releaseTime" v-bind="validateInfos.releaseTime" :validateStatus="formErrors.releaseTime ? 'error' : '' " :help="formErrors.releaseTime">
